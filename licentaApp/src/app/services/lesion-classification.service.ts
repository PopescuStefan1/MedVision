...
export class LesionClassificationService {
  ...
  private modelLoadingStatusSubject: BehaviorSubject<boolean> =
    new BehaviorSubject<boolean>(false);
  modelLoadedStatus$: Observable<boolean> =
    this.modelLoadingStatusSubject.asObservable();

  private predictionStatusSubject: BehaviorSubject<boolean> =
    new BehaviorSubject<boolean>(false);
  predictionStatus$: Observable<boolean> =
    this.predictionStatusSubject.asObservable();

  private isProcessingSubject: BehaviorSubject<boolean> =
    new BehaviorSubject<boolean>(false);
